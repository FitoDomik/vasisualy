...
import subprocess
update = ("Обнови репозитории", "обнови репозитории", "Обновление репозиториев", "обновление репозиториев",
          "Обновление репозитория", "обновление репозитория")
upgrade = ("Обнови программы", "обнови программы", "Обнови систему", "обнови систему", "Обновление программ",
           "обновление программ", "Обновление системы", "обновление системы")
def main(say, widget):
    for i in update:
        if i in say:
